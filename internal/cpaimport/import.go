...
func Import(ctx context.Context, dataStore store.Store, authDir, configPath string, overwrite bool) (Report, error) {
	...
	for _, parent := range parents {
		modelsByID[parent.UpstreamCredentialID] = append([]string(nil), parent.ModelAllowlist...)
		modelsByID[parent.UpstreamCredentialID] = append(modelsByID[parent.UpstreamCredentialID], parent.UpstreamModelAllowlist...)
	}
