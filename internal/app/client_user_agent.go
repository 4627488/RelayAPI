...
var clientUserAgentRules = []clientUserAgentRule{
	...
	{"Gemini CLI", regexp.MustCompile(`(?i)\bgemini-cli/([^\s;()]+)`)},
	...
	{"Anthropic Python SDK", regexp.MustCompile(`(?i)\b(?:anthropic/python\s+|anthropic-python/|anthropic-sdk-python/)([^\s;()]+)`)},
	{"Anthropic TypeScript SDK", regexp.MustCompile(`(?i)\b(?:anthropic/js\s+|anthropic-typescript/|anthropic-sdk-typescript/)([^\s;()]+)`)},
	{"Anthropic Go SDK", regexp.MustCompile(`(?i)\b(?:anthropic/go\s+|anthropic-go/|anthropic-sdk-go/)([^\s;()]+)`)},
