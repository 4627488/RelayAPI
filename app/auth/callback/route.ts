...
<head>
  ...
  <style>
    ...
    textarea { box-sizing: border-box; width: 100%; min-height: 112px; margin-top: 12px; border-radius: 6px; border: 1px solid var(--border); background: var(--input); color: var(--foreground); padding: 12px; font-family: "Cascadia Mono", "SFMono-Regular", Menlo, Consolas, "PingFang SC", "Microsoft YaHei UI", monospace; }
